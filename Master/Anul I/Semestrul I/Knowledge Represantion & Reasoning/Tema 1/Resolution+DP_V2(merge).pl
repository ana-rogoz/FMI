...
dp_recursive(_, _, _, "NO").
%%%dp_recursive(ClausesIn, [Head|Tail], [(Head, "False")|Result], "YES") :- select_clauses(n(Head), ClausesIn, T1), !,  
 %                                                   delete_literal(n(Head), T1, R1), !, 
  %                                                  get_clauses_without_literal(ClausesIn, Head, U1), !, 
   %                                                 union(R1, U1, Z1),
    %                                                dp_recursive(Z1, Tail, _, "NO"), !, 
     %                                               select_clauses(Head, ClausesIn, T0), !,
      %                                              delete_literal(Head, T0, R0), !, 
    	%											get_clauses_without_literal(ClausesIn, Head, U0), 
         %                                           union(R0, U0, Z0),
...
%dp_recursive(ClausesIn, [Head|Tail], [(Head, "False")|Result], Ans) :- select_clauses(Head, ClausesIn, T0), !,
 %                                                   delete_literal(Head, T0, R0), !, 
  %  												get_clauses_without_literal(ClausesIn, Head, U0), 
   %                                                 union(R0, U0, Z0),
    %                                                dp_recursive(Z0, Tail, Result, Ans), !, Ans == "NO", !. 
